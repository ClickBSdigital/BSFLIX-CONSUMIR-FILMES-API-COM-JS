var movi_api = [
    {
        ...
        posterUrl:
        'https://th.bing.com/th/id/OIP.KWx66u6b2PUDHYk_u_3tSwHaK3?pid=ImgDet&rs=1'
    },
    {
        id: 6,
        title: 'Ratatouille',
    ...
    },
    {
        ...
        posterUrl: 'https://picfiles.alphacoders.com/350/thumb-1920-350230.jpg'
    },
    {
        id: 52,
    ...
    },
    {
        ...
        posterUrl:
        'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/a2c5f707-db48-4826-ab77-f7d1cc401f08/dh5pd2r-e87012c2-c987-42b9-a00c-f281765faadd.png/v1/fit/w_828,h_1242/despicable_me_2__2013__by_sph1nx1986_dh5pd2r-414w-2x.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..-0Uk-aOav2EqqJ5VxMFCH5XORgzmCm6YzJ5w_ORRn0k'
    },
    {
        id: 61,
        title: 'Downfall',
...
window.onload = function () {
    ...
    movi_api.forEach(function(movie) {
        var filme = document.createElement('div');
        filme.className = 'filme'; // Classe para estilização
        filme.innerHTML = `
            <h2>${movie.title} (${movie.year})</h2>
            <img src="${movie.posterUrl}" alt="${movie.title}">
            <p>${movie.plot}</p>
        `;
        movieContainer.appendChild(filme);
    });
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            e.preventDefault();
            var category = this.getAttribute('href').substring(1);
...
function filterMovies(category) {
    var movieContainer = document.getElementById('movie');
    movieContainer.innerHTML = ''; // Limpa a lista de filmes

    movi_api.forEach(function(movie) {
        if (category === 'all' || movie.genres.includes(category.charAt(0).toUpperCase() + category.slice(1))) {
            var filme = document.createElement('div');
